    ...
    <div class="col-md-8">
      <div style="position:relative; width: 100%;">
        <div style="width:100%; height: auto;">
          <img src="{{ asset('storage/images/circle/'.$post->image_path) }}" oncontextmenu="return false;" onselectstart="return false;" onmousedown="return false;" style="width:100%; ; vertical-align: middle; object-fit: cover; border-radius: 5px; user-select: none;">
        </div>
      </div>
      <div class="show">
        <table>
...
<div class="mb-4 text-center" style="margin-top:10px">
  <a href=" {{ route('posts.index') }}" class="btn btn--yellow">戻る</a>
</div>
