    ...
    <div class="container">
      ...
      <div class=" row justify-content-center mt-4">
        <ul>
          ...
          <li style="padding-right:20px;"><a class="btn etc-btn btn-hai" href="/recommend"><i class="bi bi-music-note-beamed text-gray" style="padding:7px" target=" _blank"></i><br><span class="header-hide">おすすめの設定</span></a></li>
        </ul>
      </div>
    </div>
